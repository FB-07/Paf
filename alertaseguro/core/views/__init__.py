...
from .auth import editar_perfil, login_view, registo_view, verify_email, delete_account, logout_view, perfil_view, forgot_password_view, reset_password_view, delete_account_logged
